...
const Brandpartlogo = () => {
    return (
        ...
        <div className="hmbnnrbrandprtlogo">
            <img src={brandlogo1}  data-aos="fade-down"/><br />
            <p>
        ...
        <div className="hmbnnrbrandprtlogo">
            <img src={brandlogo2} data-aos="fade-down" /><br />
            <p>
        ...
        <div className="hmbnnrbrandprtlogo">
            <img src={brandlogo3} data-aos="fade-down" /><br />
            <p>
        ...
        <div className="hmbnnrbrandprtlogo">
            <img src={brandlogo4} data-aos="fade-down" /><br />
            <p>
